...
import com.my.path.databinding.FragmentRegisteredEmailBinding
 ...
 * @description　: 登录
 */
class RegisteredEmailFragment : BaseFragment<RegisteredViewModel, FragmentRegisteredEmailBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mDatabind.viewTextInputPwd.textView31.text = getString(R.string.shoujihuzce)
...
//        }
    ...
    inner class ProxyClick {
        ...
        fun sendCode(){
            when {
                phoneViewModel.userName.get().isEmpty() -> showMessage(getString(R.string.tianxieyouxdase))
                else -> requestLoginViewModel.registerSendemail(phoneViewModel.userName.get()
                )
            }
        }
    ...
    private fun check(){
        if(""!=phoneViewModel.userName.get()&&
            ...
            requestLoginViewModel.registerEmail(
