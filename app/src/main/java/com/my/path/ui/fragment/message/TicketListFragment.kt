...
import com.my.path.data.model.bean.TipTicketData
 ...
 * @description　: h5页面
 */
class TicketListFragment : BaseFragment<MessageListViewModel, FragmentTicketListBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mDatabind.page.onRefresh {
            messageRequestViewModel.tipTicket(mViewModel.currentBid.get(),index)
        }
    ...
    override fun createObserver() {
        ...
        messageRequestViewModel.tipTicketResult.observe(viewLifecycleOwner, Observer {
            it.listData.forEach {
            ...
            //loadListData(it,mDatabind.rv,mDatabind.page)
        })
    }
