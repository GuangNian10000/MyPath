 ...
 */
class DefineLoadMoreView(context: Context) : LinearLayout(context), SwRecyclerView.LoadMoreView, View.OnClickListener {

    val mProgressBar: ProgressBar
    private val mTvMessage: TextView

    private var mLoadMoreListener: SwRecyclerView.LoadMoreListener? = null

    fun setmLoadMoreListener(mLoadMoreListener: SwRecyclerView.LoadMoreListener) {
     ...
     */
    override fun onWaitToLoadMore(loadMoreListener: SwRecyclerView.LoadMoreListener) {
