...
import me.guangnian.mvvm.network.BaseNetworkApi
import me.guangnian.mvvm.network.interceptor.CacheInterceptor
...
val apiService: ApiService by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) {
    NetworkApi.INSTANCE.getApi(ApiService::class.java, ApiService.SERVER_URL_CN)
}
...
class NetworkApi : BaseNetworkApi() {
    ...
    override fun setHttpClientBuilder(builder: OkHttpClient.Builder): OkHttpClient.Builder {
        builder.apply {
            ...
            //.addInterceptor(RetryInterceptor(3))//重试
