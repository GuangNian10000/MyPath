package com.my.path.app.weight.recyclerview;
...
//    private AdapterWrapper mAdapterWrapper;
    ...
    public SwRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwRecyclerView(Context context, AttributeSet attrs, int defStyle) {
...
//        this.mOnItemClickListener = new com.yanzhenjie.recyclerview.SwipeRecyclerView.ItemClickListener(this, listener);
//    }
    ...
    private static class ItemClickListener implements OnItemClickListener {
        ...
        public ItemClickListener(com.yanzhenjie.recyclerview.SwipeRecyclerView recyclerView, OnItemClickListener listener) {
...
//        this.mOnItemLongClickListener = new com.yanzhenjie.recyclerview.SwipeRecyclerView.ItemLongClickListener(this, listener);
//    }
    ...
    private static class ItemLongClickListener implements OnItemLongClickListener {
        ...
        public ItemLongClickListener(com.yanzhenjie.recyclerview.SwipeRecyclerView recyclerView, OnItemLongClickListener listener) {
            this.mRecyclerView = recyclerView;
            this.mListener = listener;
        }
...
//        this.mOnItemMenuClickListener = new com.yanzhenjie.recyclerview.SwipeRecyclerView.ItemMenuClickListener(this, listener);
//    }
    ...
    private static class ItemMenuClickListener implements OnItemMenuClickListener {
        ...
        public ItemMenuClickListener(com.yanzhenjie.recyclerview.SwipeRecyclerView recyclerView, OnItemMenuClickListener listener) {
            this.mRecyclerView = recyclerView;
            this.mListener = listener;
        }
...
//     * @param duration time millis.
//     */
//    public void smoothOpenMenu(int position, @com.yanzhenjie.recyclerview.SwipeRecyclerView.DirectionMode int direction, int duration) {
...
//    }
    ...
    private SwRecyclerView.LoadMoreView mLoadMoreView;
    private SwRecyclerView.LoadMoreListener mLoadMoreListener;
...
//    }
     ...
     * Load more view.
     */
    public void setLoadMoreView(SwRecyclerView.LoadMoreView view) {
        mLoadMoreView = view;
    }
     ...
     * Load more listener.
     */
    public void setLoadMoreListener(SwRecyclerView.LoadMoreListener listener) {
     ...
     *
     * @see com.yanzhenjie.recyclerview.SwipeRecyclerView.LoadMoreView#onWaitToLoadMore(com.yanzhenjie.recyclerview.SwipeRecyclerView.LoadMoreListener)
     */
    ...
    public interface LoadMoreView {
         ...
         * Non-auto-loading mode, you can to click on the item to load.
         */
        void onWaitToLoadMore(SwRecyclerView.LoadMoreListener loadMoreListener);
